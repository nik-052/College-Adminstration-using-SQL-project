    ...
    def __init__(self, master):
        ...
        def Receipt():
            ...
            self.Display.insert(END, '\tStudent Name  :' +
                                self.name.get() + '\n')
            self.Display.insert(END, '\tRoll Number\t:' +
                                self.admsn.get() + '\n')
            self.Display.insert(
        ...
        # ==================================================Frames===================================================
        Main_Frame = Frame(self.master, bg='Aqua')
        Main_Frame.grid()

        Title_Frame = LabelFrame(
            Main_Frame, width=1350, height=100, bg='Aqua', relief='ridge', bd=15)
        Title_Frame.pack(side=TOP)

        self.lblTitle = Label(Title_Frame, font=('times new roman', 40, 'bold'), text='FEE REPORT',
                              bg='Aqua', padx=13)
        self.lblTitle.grid(padx=400)

        Data_Frame = Frame(Main_Frame, width=1350, height=350,
                           bg='Aqua', relief='ridge', bd=15)
        Data_Frame.pack(side=TOP, padx=15)

        Frame_1 = LabelFrame(Data_Frame, width=850, height=350, bg='Aqua', relief='ridge', bd=8,
                             text='Informations', font=('times new roman', 15, 'bold'))
        Frame_1.pack(side=LEFT, padx=10)

        Frame_2 = LabelFrame(Data_Frame, width=495, height=350, bg='Aqua', relief='ridge', bd=8,
                             text='Fee Receipt', font=('times new roman', 15, 'bold'))
        ...
        self.recpt_label = Label(Frame_1, text='Receipt No. : ', font=(
            'times new roman', 14, 'bold'), bg='Aqua')
        ...
        self.admsn_label = Label(Frame_1, text='Roll Number : ', font=(
            'times new roman', 14, 'bold'), bg='Aqua')
        ...
        self.branch_entry = ttk.Combobox(Frame_1, values=(' ', 'CSE', 'IT', 'ETC/ET&T', 'Mechanical', 'Civil', 'EE', 'EEE'),
                                         font=('times new roman', 14), width=19, textvariable=self.branch)
        ...
        self.total_entry = Entry(Frame_1, font=(
            'times new roman', 14), width=10, textvariable=self.var_1, state='readonly')
        self.total_entry.grid(row=2, column=3, padx=8, pady=5)

        self.paid_entry = Entry(Frame_1, font=(
            'times new roman', 14), width=10, textvariable=self.paid)
        self.paid_entry.grid(row=3, column=3, pady=5)

        self.due_entry = Entry(Frame_1, font=(
            'times new roman', 14), width=10, textvariable=self.due)
        ...
        self.list = Listbox(List_Frame, font=(
            'times new roman', 13, 'bold'), width=140, height=8)
