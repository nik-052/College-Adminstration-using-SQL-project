...
class Window_1():
       def __init__(self, master):
              ...
              self.roll = StringVar()
              frame = LabelFrame(self.master, width = 1000, height = 100, font = ('times new roman',30,'bold'), relief = 'ridge', bd = 15, bg = 'aqua')
              frame.grid(row = 1, column = 0, padx = 200, pady = 200)

              label = Label(frame, text = 'Enter Roll Number', font = ('times new roman',25,'bold'), bg = 'aqua' )
              label.grid(row = 0, column = 0, padx = 100, pady = 10)

              entry = Entry(frame, font = ('times new roman',25,'bold'), textvariable = self.roll)
              ...
              btnSearch = Button(frame, text = 'SEARCH', width = 15, font = ('times new roman',15,'bold'), command=Search)
              btnSearch.grid(row = 1, column = 0, padx = 50)
              btnNew = Button(frame, text = 'CREATE NEW', width = 15, font = ('times new roman',15,'bold'), command=new)
